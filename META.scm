...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "A Discord bot that promotes sustainability in the garment and fashion industry by providing insights, tracking, and actionable information about sustainable fashion practices.")
...
(define development-practices
  '((code-style
     (languages . ("Dockerfile" "HTML" "Just" "Makefile" "PowerShell" "Python" "Scheme" "Shell"))
