...
(define metadata
  '((version . "0.1.0")
    ...
    (updated . "2025-12-15")
    (project . "gsbot")
    (repo . "github.com/hyperpolymath/gsbot")))
...
(define project-context
  '((name . "gsbot")
    (tagline . "A Discord bot that promotes sustainability in the garment and fashion industry by providing insights, tracking, and actionable information about sustainable fashion practices.")
    (version . "0.1.0")
